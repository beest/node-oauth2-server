...
TokenHandler.prototype.getClient = function(request, response) {
  ...
  if ((grantType !== 'authorization_code' && grantType !== 'refresh_token') && !credentials.clientSecret) {
...
TokenHandler.prototype.getClientCredentials = function(request) {
  ...
  if ((grantType === 'authorization_code' || grantType === 'refresh_token') && request.body.client_id) {
