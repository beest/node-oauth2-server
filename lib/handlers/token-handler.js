...
TokenHandler.prototype.getClient = function(request, response) {
  ...
  if (grantType !== 'authorization_code' && !credentials.clientSecret) {
  ...
  if (grantType !== 'authorization_code' && !is.vschar(credentials.clientSecret)) {
...
TokenHandler.prototype.getClientCredentials = function(request) {
  ...
  if (grantType === 'authorization_code' && request.body.client_id) {
