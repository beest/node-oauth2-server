...
TokenHandler.prototype.getClient = function(request, response) {
  ...
  if ((grantType !== 'authorization_code' && grantType !== 'refresh_token' && grantType !== 'password') && !credentials.clientSecret) {
  ...
  if ((grantType !== 'authorization_code' && grantType !== 'refresh_token') && !is.vschar(credentials.clientSecret)) {
    throw new InvalidRequestError('Invalid parameter: `client_secret`');
  }

  return promisify(this.model.getClient, 3)(credentials.clientId, credentials.clientSecret, request)
    .then(function(client) {
      if (!client) {
...
TokenHandler.prototype.getClientCredentials = function(request) {
  ...
  if ((grantType === 'authorization_code' || grantType === 'refresh_token' || grantType === 'password') && request.body.client_id) {
